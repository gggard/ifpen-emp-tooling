 ...
 * @generated
 */
public class CuboidModelerSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case CuboidModelerPackage.SCENE: {
                Scene scene = (Scene)theEObject;
                T result = caseScene(scene);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case CuboidModelerPackage.CUBOID: {
                Cuboid cuboid = (Cuboid)theEObject;
                T result = caseCuboid(cuboid);
                if (result == null) result = caseSceneObj(cuboid);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case CuboidModelerPackage.SCENE_OBJ: {
                SceneObj sceneObj = (SceneObj)theEObject;
                T result = caseSceneObj(sceneObj);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Scene Obj</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Scene Obj</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseSceneObj(SceneObj object) {
        return null;
    }
